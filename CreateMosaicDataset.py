...
for ras in rasters:
	...
	arcpy.management.CreateMosaicDataset("BIBE_CORE_NightRadiance.gdb", msic, 
		"GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],\
		PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]]",
		None, '', "NONE", None)
	arcpy.management.AddRastersToMosaicDataset("BIBE_CORE_NightRadiance.gdb/" + msic, "Raster Dataset", ras, 
